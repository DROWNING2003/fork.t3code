...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "Boundly Connect" section title + refresh button for hosts that
...
/**
 * "Boundly Connect" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the Boundly Connect
 * onboarding sheet.
 *

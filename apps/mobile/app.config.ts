    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Boundly agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Boundly to connect to Boundly servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Boundly to access your camera so you can scan pairing QR codes.",

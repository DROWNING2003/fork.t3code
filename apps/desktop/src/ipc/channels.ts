...
export const GET_SANDBOX_CREDENTIALS_CHANNEL = "desktop:get-sandbox-credentials";
export const SET_SANDBOX_CREDENTIALS_CHANNEL = "desktop:set-sandbox-credentials";
export const CLEAR_SANDBOX_CREDENTIALS_CHANNEL = "desktop:clear-sandbox-credentials";
